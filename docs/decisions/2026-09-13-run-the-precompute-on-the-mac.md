...
The hosting research note's budget of 1 to 10 days and a rented 64 GB machine is superseded by these measurements. It rested on provisioning estimates that it labelled as estimates, and the measured import is 60 to 360 times faster than that estimate and the measured sweep 3 to 30 times faster.
