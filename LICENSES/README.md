...
| National Rail timetable (Rail Delivery Group or Network Rail CIF) | Pending, product-specific agreement | Pending | Pending: read the agreement on registration and add its text here. |
